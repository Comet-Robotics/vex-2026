...
public:
        ...
        const double theta_sigma = 0.01)
    {
        ...
        auto x_sigma_dist = std::normal_distribution<double>(0.0, x_sigma);
        auto y_sigma_dist = std::normal_distribution<double>(0.0, y_sigma);
        auto theta_sigma_dist = std::normal_distribution<double>(0.0, theta_sigma);
...
private:
    ...
    const double particleInjectionFraction; // Fraction of particles to inject randomly
    const Map map_;
